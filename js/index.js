...
//PARALLAX MOVEMENT
$("#fullgrid").mousemove(function(e) {
  parallaxIt(e, ".brush", -30);
  parallaxIt(e, ".centsvg ", 5);
  parallaxIt(e, ".tweenbase", -30);
  parallaxIt(e, ".tweenbackboxspec", -160);
  parallaxIt(e, "h1", -20);
...
$( '[class*=svg]' ).mousemove(function( event ) {
$('#blurthis').toggleClass('blur');
});
